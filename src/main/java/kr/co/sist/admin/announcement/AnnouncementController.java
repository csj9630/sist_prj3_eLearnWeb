...
public class AnnouncementController {
	...
	public String announcementList(RangeDTO rDTO, Model model) {
		...
		List<AnnouncementDomain> announcementList = as.searchAnnouncementList(rDTO); // 게시글 내용
	...
	public String writeFormProcess(HttpSession session, AnnouncementDTO aDTO, HttpServletRequest request, Model model) {
	...
	public String announcementDetail(@RequestParam(defaultValue = "0") int annId, Model model) {
		AnnouncementDomain announcementDomain =  as.searchOneAnnouncement(annId);
	...
	public String modifyAnnouncementProcess(HttpSession session, AnnouncementDTO aDTO, HttpServletRequest request, Model model) {
		aDTO.setRegip(request.getRemoteAddr());
	...
	public String removeAnnouncementProcess(HttpSession session, AnnouncementDTO aDTO, Model model) {
