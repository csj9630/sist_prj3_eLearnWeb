...
public class AdminReviewService {
	 ...
	 * @return
	 */
	public int totalCnt(AdminReviewRangeDTO rangeDTO) {
		int totalCnt = 0;
	 ...
	 * @return
	 */
	public List<AdminReviewDomain> searchReviewList(AdminReviewRangeDTO rangeDTO) {
	 ...
	 * @param list
	 */
	public void contentSubStr(List<AdminReviewDomain> reviewList) {
		String content = "";
		for (AdminReviewDomain rDomain : reviewList) {
	...
	public String pagination(AdminReviewRangeDTO rangeDTO) {
	 ...
	 * @return
	 */
	public AdminReviewDomain searchOneReview(String reviewId) {
		AdminReviewDomain rDomain = null;
	...
	public boolean removeReview(AdminReviewDTO rDTO) {
		boolean flag = false;
	...
	// 리뷰리스트 암호화된 이름 복호화
	private void decryptReviewAuthorInfo(List<AdminReviewDomain> reviewList) {
		if (reviewList == null || reviewList.isEmpty()) {
			return;
		}
		for (AdminReviewDomain review : reviewList) {
