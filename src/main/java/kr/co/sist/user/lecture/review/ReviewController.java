...
public class ReviewController {
	...
	public String reviewList(RangeDTO rDTO, Model model) {
		...
		List<ReviewDomain> reviewList = rs.searchReviewList(rDTO); // 게시글 내용
	...
	public String writeForm(HttpServletRequest request, Model model) {
		...
		return "/lecture/review/writeFrm";
	} // writeForm
	
	@PostMapping("/reviewWriteFrmProcess")
	public String writeFormProcess(HttpSession session, ReviewDTO rDTO, HttpServletRequest request, Model model) {
		...
		return "/lecture/review/reviewWriteFrmProcess";
	} // writeFormProcess
	
	@GetMapping("/reviewDetail")
	public String reviewDetail(@RequestParam(defaultValue = "0") int annId, Model model) {
		ReviewDomain reviewDomain =  rs.searchOneReview(annId);
		model.addAttribute("reviewDomain", reviewDomain);

		
		return "/lecture/review/reviewDetail";
	} // reviewDetail
	
	@PostMapping("/modifyReviewProcess")
	public String modifyReviewProcess(HttpSession session, ReviewDTO rDTO, HttpServletRequest request, Model model) {
		rDTO.setRegip(request.getRemoteAddr());
		...
		return "/lecture/review/modifyReviewProcess";
	} // modifyReviewProcess
	
	@PostMapping("/removeReviewProcess")
	public String removeReviewProcess(HttpSession session, ReviewDTO rDTO, Model model) {
		...
		return "/lecture/review/removeReviewProcess";
	} // removeReviewProcess
