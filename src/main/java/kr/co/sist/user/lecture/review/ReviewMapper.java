...
public interface ReviewMapper {
	...
	public void insertReview(ReviewDTO reviewDTO) throws PersistenceException;
	
	// (만일 키워드가 있다면 키워드를 포함하는 내용의)공지사항 개수를 조회
	// <select id = "selectReviewTotalCnt" parameterType = "userReviewRangeDTO" resultType = "int">
	public int selectReviewTotalCnt(RangeDTO rangeDTO) throws SQLException;
	...
	public List<ReviewDomain> selectRangeReview(RangeDTO rangeDTO) throws SQLException;
	
	// 공지사항 아이디를 받아서 해당하는 공지사항 하나를 자세히 조회
	// <select id = "selectReviewDetail" parameterType = "Integer" resultType = "userReviewDomain">
	public ReviewDomain selectReviewDetailUser(int reviewId) throws SQLException;
	
	// 공지사항 아이디를 받아서 해당하는 공지사항 하나를 자세히 조회
	// <select id = "selectReviewDetail" parameterType = "Integer" resultType = "userReviewDomain">
	public ReviewDomain selectReviewDetailInstructor(int reviewId) throws SQLException;
	
	// 공지사항 아이디를 받아서 해당하는 공지사항 하나를 자세히 조회
	// <select id = "selectReviewDetail" parameterType = "Integer" resultType = "userReviewDomain">
	public ReviewDomain selectReviewDetailAdmin(int reviewId) throws SQLException;
	...
	public int deleteReview(ReviewDTO reviewDTO) throws SQLException;
