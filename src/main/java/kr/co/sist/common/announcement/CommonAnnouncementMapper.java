...
@Mapper
public interface CommonAnnouncementMapper {
	
	// 신규 공지사항을 등록
	// <insert id = "insertAnnouncement" parameterType = "announcementDTO">
	public void insertAnnouncement(CommonAnnouncementDTO announcementDTO) throws PersistenceException;
	
	// (만일 키워드가 있다면 키워드를 포함하는 내용의)공지사항 개수를 조회
	// <select id = "selectAnnouncementTotalCnt" parameterType = "rangeDTO" resultType = "int">
	public int selectAnnouncementTotalCnt(CommonAnnouncementRangeDTO rangeDTO) throws SQLException;
	...
	public List<CommonAnnouncementDomain> selectRangeAnnouncement(CommonAnnouncementRangeDTO rangeDTO) throws SQLException;
	
	// 공지사항 아이디를 받아서 해당하는 공지사항 하나를 자세히 조회
	// <select id = "selectAnnouncementDetail" parameterType = "Integer" resultType = "announcementDomain">
	public CommonAnnouncementDomain selectAnnouncementDetail(int annId) throws SQLException;
	...
	public int updateAnnouncement(CommonAnnouncementDTO announcementDTO) throws SQLException;
	
	// 공지사항 아이디와 관리자 아이디를 입력 받아 관리자임을 확인 후 해당 공지사항을 삭제
	// <delete id = "deleteAnnouncement" parameterType = "announcementDTO">
	public int deleteAnnouncement(CommonAnnouncementDTO announcementDTO) throws SQLException;
