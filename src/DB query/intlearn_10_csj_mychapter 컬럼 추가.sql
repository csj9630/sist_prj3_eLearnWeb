...
INSERT INTO CHAPTER (CHPTR_ID, NUM, NAME, LENGTH, DOC, DOCREGDATE, VIDEO, REGDATE, LECT_ID)
VALUES ('CH' || SEQ_CHAPTER_ID.NEXTVAL, (SELECT NVL(MAX(NUM), 0) + 1 FROM CHAPTER WHERE LECT_ID = 'L1'), '컬렉션 프레임워크', 30, 'java_04.ppt', TO_DATE('2025-01-13','YYYY-MM-DD'), 'FtY9ksEUbvo', SYSDATE, 'L1');
